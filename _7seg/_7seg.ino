...
#define CPU_PRESCALE(n) (CLKPR = 0x80, CLKPR = (n)) //function to scale cpu speed
#define CPU_250kHz      0x06 //cpu runs at max 250kHz
...
//   }
  delay(2000);
  write_led_decimals(2); // All decimal points off
  write_led_numbers(2,2,9,5); // All decimal points off
}
